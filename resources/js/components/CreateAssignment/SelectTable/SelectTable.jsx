...
function SelectTable(props) {
    ...
    useEffect(() => {
        const showModal = async () => {
            ...
            if (table) {
                await dispatch(setSort('full_name', 2));
            } else {
                await dispatch(setSort('asset_name', 2));
            }
        };
        showModal();
    }, [show]);
    useEffect(() => {
        ...
        getUserList();
    }, [sortAction, successLoadingUser, successLoadingAsset]);

    console.log(sortAction.sortColumn);

    const handleClickSort = async (sortName) => {
    ...
    const handleCheckRadio = async (e) => {
        if (table) {
            await userList.forEach((user) => {
                SetCheckRadio(e.target.value);
                if (user.id === parseInt(e.target.value)) {
                    setCheckUser(user.full_name);
                }
            });
        } else {
            await assetList.forEach((asset) => {
                SetCheckRadioAsset(e.target.value);
                if (asset.id === parseInt(e.target.value)) {
                    setCheckAsset(asset.asset_name);
                }
            });
        }
        console.log(checkRadio + 'hello');
    };
    const handleSubmit = () => {
        if (table) {
            dispatch(setUserAssignment(checkRadio, checkUser));
        } else {
            dispatch(setAssetAssignment(checkRadioAsset, checkAsset));
        }
        setIsShow(false);
    };
                            ...
                            <div className="scroll-select">
                                <div className="list-select">
                                    <Row>
                                        ...
                                        <Col
                                            xs={3}
                                            className="col-box-modal-create"
                                        >
                                            <div
                                                className="field"
                                                onClick={() =>
                                        ...
                                        <Col
                                            xs={3}
                                            className="col-box-modal-create-type"
                                        >
                                            <div
                                                className="field"
                                                onClick={() =>
                            ...
                            <div className="scroll-select">
                                <div className="list-select">
                                    <Row>
                                        ...
                                        <Col
                                            xs={3}
                                            className="col-box-modal-create-selcet-category"
                                        >
                                            <div
                                                className="field"
                                                onClick={() =>
